...
class TextAnnotator {
    ...
    search(searchText, { prefix = '', postfix = '', trim = true, caseSensitive = false, offset = 0, } = {}) {
    ...
    annotate(annotationIndex, { tagName = 'span', baseClassName = 'annotation', classPattern = 'annotation-', } = {}) {
    ...
    unannotate(annotationIndex) {
        ...
        const otherTags = this.tags.filter((tag) => tag.annotationIndex !== annotationIndex);
